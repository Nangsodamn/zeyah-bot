...
// src/components.tsx
var import_styler = require("@nea-liane/styler");
...
var Bold = ({ childrenString }) => {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Platform, { type: "facebook", children: (0, import_styler.applyFonts)(childrenString, "bold") }),
...
var Italic = ({ childrenString }) => {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Platform, { type: "facebook", children: (0, import_styler.applyFonts)(childrenString, "fancy_italic") }),
    /* @__PURE__ */ jsx(Platform, { type: "discord", children: `*${escapeDiscordMarkdown(childrenString)}*` })
  ] });
};
...
var UniFont = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Platform, { type: "facebook", children: (0, import_styler.applyFonts)(childrenString, type) }),
    /* @__PURE__ */ jsx(Platform, { type: "discord", children: escapeDiscordMarkdown(childrenString) }),
    " "
  ] });
};
...
var Text = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Platform, { type: "facebook", children: (0, import_styler.applyFonts)(childrenString, "fancy") }),
...
var Heading = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Platform, { type: "facebook", children: (0, import_styler.applyFonts)(childrenString, fbFont) }),
...
var Line = ({}) => /* @__PURE__ */ jsxs(Fragment, { children: [
  /* @__PURE__ */ jsx(Platform, { type: "facebook", children: import_styler.UNIRedux.standardLine }),
  /* @__PURE__ */ jsx(Platform, { type: "discord", children: import_styler.UNIRedux.standardLine })
] });
var List = ({
  ordered = false,
  prefix = "\u2022",
  ...
  const lines = childrenData.map((child) => {
    ...
    if (isItem) {
      ...
      const line = ordered ? `${ind}${boldPrefix ? platform === "facebook" ? (0, import_styler.applyFonts)(counter.toString(), "bold") : `**${counter}**` : counter}. ${rendered}` : `${ind}${platform === "discord" ? "-" : prefix} ${rendered}`;
      counter++;
      return line;
    } else {
      return rendered;
...
var ZeyahFiber = class _ZeyahFiber {
  ...
  collectChildren() {
    const res2 = _ZeyahFiber.collectChildren(this.jsxElem.children, this.root);
    this.children = res2;
  }
  detectedParent;
  get rootState() {
  ...
  render(platform) {
    ...
    const childrenData = this.children.filter(NullishFilter).flatMap((c) => {
      ...
      const getRendered = () => {
        ...
        const res2 = isString ? c : c.render(platform).join("");
        cache = res2;
        return res2;
      };
      return {
    ...
    const getChildrenString = () => {
      ...
      const res2 = childrenData.map((i) => i.getRendered()).join("");
      childrenString = res2;
      return res2;
    };
...
// src/test.tsx
var favItems = ["Minecraft", "GD", "Coding", "IbisPaint"];
var res = /* @__PURE__ */ jsxs(Fragment, { children: [
  "Ang crush ko po ay si",
  " ",
  /* @__PURE__ */ jsx(Spoiler, { children: /* @__PURE__ */ jsx(Bold, { children: "Secret, baliw" }) }),
  /* @__PURE__ */ jsx(Break, {}),
  /* @__PURE__ */ jsx("br", {}),
  /* @__PURE__ */ jsx(Heading, { level: 2, children: "My Fav things:" }),
  /* @__PURE__ */ jsx("br", {}),
  /* @__PURE__ */ jsx(List, { ordered: true, indent: 2, boldPrefix: true, children: favItems.map((i) => /* @__PURE__ */ jsx(ListItem, { children: i })) }),
...
var test1 = /* @__PURE__ */ jsxs(CassFormat, { title: "\u{1F388} Test", fbContentFont: "fancy", fbTitleFont: "bold", children: [
  "Hi bozo!",
  /* @__PURE__ */ jsx(Break, {}),
  /* @__PURE__ */ jsx(Italic, { children: "Well... Well.. Hmm." })
] });
console.log();
console.log();
...
var test2 = /* @__PURE__ */ jsxs(Fragment, { children: [
  "Hello, ",
  /* @__PURE__ */ jsx(Bold, { children: "World!" }),
  /* @__PURE__ */ jsx("br", {}),
  /* @__PURE__ */ jsx(Italic, { children: "Helloooo....." }),
  /* @__PURE__ */ jsx("br", {}),
  /* @__PURE__ */ jsx(Line, {}),
  /* @__PURE__ */ jsx("br", {}),
  /* @__PURE__ */ jsx(Bold, { children: "Rules!!!" }),
  /* @__PURE__ */ jsx("br", {}),
  /* @__PURE__ */ jsx(List, { ordered: true, boldPrefix: true, children: [
    "cute si liane",
    "kayelaa na name ni liane",
    "axera-fca tomorrow",
    "may jsx na",
    "ok madam"
  ].map((i) => /* @__PURE__ */ jsx(ListItem, { children: i })) })
] });
console.log();
console.log();
console.log();
